...
from trlib.translator.beam import Beam
...
class Translator(object):
    ...
    def translate_batch(self, batch_inputs):
        ...
        code_rel_matrix_rep = batch_inputs["code_rel_matrix"]
        code_root_paths_rep = batch_inputs["code_root_paths_rep"]
        code_adj_matrix_rep = batch_inputs["adj_matrices_rep"]
        ...
        if model_name == 'Transformer':
            memory_bank, layer_wise_outputs = encoder(code_rep, code_len, code_rel_matrix_rep, code_type_rep, code_word_rep, code_adj_matrix_rep)
